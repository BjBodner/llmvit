...
def test_knn_embedder(sample_embeddings, sample_input):
...
def test_max_embedder(sample_embeddings, sample_input):
...
def test_direct_embedder(sample_embeddings, sample_input):
