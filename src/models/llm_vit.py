...
class VisionTransformer(nn.Module):
    def __init__(self, pretrained_model_name_or_path, img_size=28, patch_size=7, in_channels=1, 
        ...
        self.transformer = self._init_transformer_backbone(pretrained_model_name_or_path, depth, num_classes)
    ...
    def _init_transformer_backbone(self, pretrained_model_name_or_path, depth, num_classes):
